<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*,application_logic_layer.gestione_utente.Utente, application_logic_layer.gestione_lezioni.Lezione, application_logic_layer.gestione_lezioni.Lezione, storage_layer.QuesitoDao" %>
...
<header>
	...
	<div align= "center">
		<div id="profilo_view" align="center">
			...
			<form name="InvioRisposta" action="../InvioRisposta?id_quesito=<%=id%>" method="post">
				<h5>Risposta</h5>
				<p><textarea rows="7" cols="50" name="risposta"></textarea></p>
				<input class="tastoRispondi" type="submit" value="Invia risposta">
			</form>
			</div>
			
		</div>
		<p><a href="../VisualizzaDomande">Indietro</a></p>
	</div>
